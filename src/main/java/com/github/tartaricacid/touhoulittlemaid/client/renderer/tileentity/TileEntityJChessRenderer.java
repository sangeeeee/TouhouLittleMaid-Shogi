...
import com.github.tartaricacid.touhoulittlemaid.client.model.JChessPiecesModel;
import com.github.tartaricacid.touhoulittlemaid.client.model.bedrock.SimpleBedrockModel;
import com.github.tartaricacid.touhoulittlemaid.client.resource.BedrockModelLoader;
import com.github.tartaricacid.touhoulittlemaid.tileentity.TileEntityJChess;
...
public class TileEntityJChessRenderer implements BlockEntityRenderer<TileEntityJChess> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(TouhouLittleMaid.MOD_ID, "textures/bedrock/block/jchess.png");
    private static final ResourceLocation PIECES_TEXTURE = ResourceLocation.fromNamespaceAndPath(TouhouLittleMaid.MOD_ID, "textures/bedrock/block/jchess_pieces.png");
    ...
    private void renderTipsText(TileEntityJChess chess, PoseStack poseStack, MultiBufferSource bufferIn, int combinedLightIn) {
        ...
        MutableComponent resetTips = Component.translatable("message.touhou_little_maid.jchess.reset").withStyle(ChatFormatting.UNDERLINE).withStyle(ChatFormatting.AQUA);
